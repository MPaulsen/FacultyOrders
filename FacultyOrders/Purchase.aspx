...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="Body">
    <div> <br />
        ...
        <asp:Table runat="server" HorizontalAlign="Center">
            <asp:TableRow>
                <asp:TableCell>
                    From:<asp:TextBox ID ="Start" runat="server" Width="20"></asp:TextBox>
                    <asp:Button ID="FromCal" OnClick="FromCal_Click" runat="server" Text="Open Calender"/>
                    <asp:Calendar ID="FromCalendar" runat="server" Visible="false" Width="20"></asp:Calendar>
                </asp:TableCell>
                <asp:TableCell>
                    To:<asp:TextBox ID ="To" runat="server"></asp:TextBox>
                    <asp:Button ID="ToCal" OnClick="ToCal_Click" runat="server" Text="Open Calender"/>
                </asp:TableCell>
            </asp:TableRow>
